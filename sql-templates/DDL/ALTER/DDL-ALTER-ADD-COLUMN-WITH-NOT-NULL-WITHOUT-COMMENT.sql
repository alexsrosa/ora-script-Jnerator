/**********************************************************************************
* Descrição: Script de adição de nova coluna na #{Esquema e Tabela@Digite o esquema e a tabela. Ex.: esquema.tabela} com NOT NULL
...
BEGIN
    EXECUTE IMMEDIATE 'ALTER TABLE #{Esquema e Tabela@Digite o esquema e a tabela. Ex.: esquema.tabela} ADD #{Campo@Campo a ser incluído@30} #{Tipo de dado@Coloque o tipo de dado. Ex.: VARCHAR2(10)} ' ||
            'CONSTRAINT #{Nome da constraint@Nome padrão da constraint. Ex.: NN_DOCUMENTO_APRESENTAR_11@30} NOT NULL';
